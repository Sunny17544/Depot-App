...
class CheckoutsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create checkout" do
    assert_difference('Checkout.count') do
      post checkouts_url, params: { checkout: { address: @checkout.address, email: @checkout.email, name: @checkout.name, pay_type: @checkout.pay_type } }
    end
  ...
  test "should update checkout" do
    patch checkout_url(@checkout), params: { checkout: { address: @checkout.address, email: @checkout.email, name: @checkout.name, pay_type: @checkout.pay_type } }
